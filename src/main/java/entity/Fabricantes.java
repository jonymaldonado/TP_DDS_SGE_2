...
@NamedQueries({
    ...
    , @NamedQuery(name = "Fabricantes.findById", query = "SELECT f FROM Fabricantes f WHERE f.id = :id")
...
public class Fabricantes implements Serializable {
    ...
    public Fabricantes(Integer id) {
        this.id = id;
    }

    public Fabricantes(Integer id, String descripcion) {
        this.id = id;
    ...
    public String toString() {
        return "entity.Fabricantes[ id=" + id + " ]";
    }
