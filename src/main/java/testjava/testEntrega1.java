...
public class testEntrega1 {
	...
	public void init() {
		...
		cliente1 = new Cliente("Marta", "Farias", "DNI", 12123, 342324, 5.94f, 3.56f);
	...
	@Test
	public void consumoEnLasUltimasNHoras() {
		DispositivoInteligente dispositivo = new DispositivoInteligente("pc", 30);
		LocalDateTime fechaInicio1 = LocalDateTime.now().minusHours(50);
		LocalDateTime fechaFin1 = LocalDateTime.now().minusHours(30);
		LocalDateTime fechaInicio2 = LocalDateTime.now().minusHours(20);
		LocalDateTime fechaFin2 = LocalDateTime.now().minusHours(10);
		
		Encendido estadoUno = new Encendido("encendido", fechaInicio1, fechaFin1, 600);
		Encendido estadoDos = new Encendido("encendido", fechaInicio2, fechaFin2, 300);
		
		dispositivo.agregarEstado(estadoUno);
